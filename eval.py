...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='coco', help='coco or f30k')
    parser.add_argument('--data_path', type=str, default='/home/sculiuyang/data/coco/coco-images/', help='the path of dataset')
    ...
    if opt.dataset == 'coco':
        weights_bases = [    
            'runs/coco/swin384_distill',
            # 'runs/coco_swin',
        ]
    else:
        weights_bases = [
            'runs/f30k_swin_aeom_384',
        ]
