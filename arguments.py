...
def get_argument_parser():
    ...
    parser.add_argument('--f30k_img_path', type=str, default='/home/sculiuyang/data/f30k/flickr30k-images', help='the path of f30k images') 
    parser.add_argument('--coco_img_path', type=str, default='/home/sculiuyang/data/coco/coco-images/', help='the path of coco images') 
    

    parser.add_argument('--pretrain', action='store_true', help='long captiong pretrain.') 
    parser.add_argument('--distill', action='store_true', help='long captiong pretrain.') 
    parser.add_argument('--weight_path', type=str, default='./runs/test_pretrain/model_best.pth')
    parser.add_argument('--num_tokens', type=int, default=4, help='the token number of the prompt learner')
    parser.add_argument('--use_decoder', action='store_true', help='decode the prompt as long caption embedding')
    parser.add_argument('--no_res_embed', action='store_false', help='use residual caption embedding')
    parser.add_argument('--decoder_depth', type=int, default=4, help='decoder depth')
    parser.add_argument('--gpo', action='store_true', help='use gpo in decoder')
    parser.add_argument('--distill_loss', type=str, default='cos', help='distillation loss type')
    parser.add_argument('--temp', default=0.5, type=float, help='Rank loss margin.')
    # vision transformer
